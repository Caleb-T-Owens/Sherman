...
for modding release 1.14.0. Fabric is roughly equivalent to MCP in that it
...
Now that we understand the modding ecosystem, we can look at fixing the macOS
...
- [Glass Networking](https://modrinth.com/mod/glass-networking) - a networking library that GlassConfigAPI requires
...
Thank you to [calmilamsy](https://github.com/calmilamsy) who spotted that Fabric came out for 1.14.0, not 1.8.0. He also clarified that the mod requiring Glass Networking was in fact GlassConfigAPI.
