...
Here is a screenshot of a 4-bit CPU with four general purpose registers and two
operand registers that I built when I was 16.
...
trip. I never played beta 1.7.3 when it was in its prime. I did, however, play
