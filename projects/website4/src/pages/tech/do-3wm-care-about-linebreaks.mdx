...
description: An exploration of how three-way merge algorithms work and whether linebreaks matter. Spoiler - the merge doesn't care, but your diff engine might.
---
